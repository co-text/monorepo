...
export class ActionsController extends BaseController {
    ...
    ShiftArrowLeft() {
        this.selection.expand(CursorMove.Left)
    }

    ShiftArrowRight() {
        this.selection.expand(CursorMove.Right)
    }

    ArrowLeft() {
        this.selection.move(CursorMove.Left)
    }

    ArrowRight() {
        this.selection.move(CursorMove.Right)
    }

    CtrlArrowLeft() {
        this.selection.move(CursorMove.WordLeft)
    }

    CtrlArrowRight() {
        this.selection.move(CursorMove.WordRight)
    }

    CtrlShiftArrowLeft() {
        this.selection.expand(CursorMove.WordLeft)
    }

    CtrlShiftArrowRight() {
        this.selection.expand(CursorMove.WordRight)
    }

    ArrowUp() {
        this.selection.move(CursorMove.Up)
    }

    ArrowDown() {
        this.selection.move(CursorMove.Down)
    }

    ShiftArrowUp() {
        this.selection.expand(CursorMove.Up)
    }

    ShiftArrowDown() {
        this.selection.expand(CursorMove.Down)
    }

    End() {
        this.selection.move(CursorMove.End)
    }

    Home() {
        this.selection.move(CursorMove.Home)
    }

    ShiftEnd() {
        this.selection.expand(CursorMove.End)
    }

    ShiftHome() {
        this.selection.expand(CursorMove.Home)
    }
